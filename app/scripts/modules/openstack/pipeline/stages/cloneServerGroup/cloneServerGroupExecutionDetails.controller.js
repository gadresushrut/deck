...
module.exports = angular.module('spinnaker.core.pipeline.stage.cloneServerGroup.openstack.executionDetails.controller', [
  ...
  .controller('openstackCloneServerGroupExecutionDetailsCtrl', function ($scope, $stateParams, executionDetailsSectionService, $timeout, urlBuilderService, clusterFilterService) {
